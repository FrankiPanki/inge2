...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`alumno` (
  ...
  INDEX `a_idUsuario` (`username` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`horario` (
  ...
  INDEX `h_idProfesor` (`idProfesor` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`materia` (
  ...
  INDEX `m_idNivel` (`idNivel` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`tema` (
  ...
  PRIMARY KEY (`idTema`),
  INDEX `t_idMateria` (`idMateria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`asesorar` (
  ...
  INDEX `a_idHorario` (`idHorario` ASC) VISIBLE,
  INDEX `a_idTema` (`idTema` ASC) VISIBLE,
  INDEX `a_idProfesor` (`idProfesor` ASC) VISIBLE,
  INDEX `a_idAlumno` (`idAlumno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`interesar` (
  ...
  INDEX `i_idNivel` (`idNivel` ASC) VISIBLE,
  INDEX `i_idMateria` (`idMateria` ASC) VISIBLE,
  INDEX `i_idTema` (`idTema` ASC) VISIBLE,
  INDEX `i_idUsuario` (`username` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Sistema_colaborativo`.`tarjeta` (
  ...
  INDEX `t_idUsuario` (`username` ASC) VISIBLE,
